...
typedef struct generic_linear_analog_type // 64 bytes
{
  ...
  float m;                            // 2bytes, slope
  float b;                            // 2bytes, y-intercept
  short order_of_magnitude;
  float x1;                         // 2bytes for 2pt calibration
  float y1;                         // 2bytes for 2pt calibration
  float x2;                         // 2bytes for 2pt calibration
  float y2;                         // 2bytes for 2pt calibration
...
private:
  ...
  double calibrate_high_reading = 0;
  double calibrate_high_value = 0;
  double calibrate_low_reading = 0;
