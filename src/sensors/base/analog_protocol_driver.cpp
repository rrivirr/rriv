...
#include "analog_protocol_driver.h"
...
void AnalogProtocolSensorDriver::setDriverDefaults()
{
...
configuration_bytes_partition AnalogProtocolSensorDriver::getDriverSpecificConfigurationBytes()
{
...
void AnalogProtocolSensorDriver::configureSpecificConfigurationsFromBytes(configuration_bytes_partition configurationPartition)
{
  memcpy(&configurations, &configurationPartition, sizeof(generic_linear_analog_config));
}


void AnalogProtocolSensorDriver::appendDriverSpecificConfigurationJSON(cJSON * json)
{
...
const char *AnalogProtocolSensorDriver::getBaseColumnHeaders()
{
  return baseColumnHeaders;
}

void AnalogProtocolSensorDriver::stop() {}

bool AnalogProtocolSensorDriver::takeMeasurement()
{
...
void AnalogProtocolSensorDriver::takeCalibrationBurstMeasurement()
{
...
const char *AnalogProtocolSensorDriver::getDataString()
{
...
void AnalogProtocolSensorDriver::initCalibration()
{
...
void AnalogProtocolSensorDriver::printCalibrationStatus()
{
...
void AnalogProtocolSensorDriver::calibrationStep(char *step, int arg_cnt, char ** args)
{
...
void AnalogProtocolSensorDriver::computeCalibratedCurve() // calibrate using linear slope equation, log time
{
...
void AnalogProtocolSensorDriver::addCalibrationParametersToJSON(cJSON *json)
{
