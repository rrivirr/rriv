...
bool AtlasScientificEC::setup() {
    ...
    success &= _i2c->write(( uint8_t*)"O,EC,1", 6);  // Enable conductivity
    ...
    _i2c->beginTransmission(_i2cAddressHex);
    success &= _i2c->write(( uint8_t*)"O,TDS,1",
    ...
    _i2c->beginTransmission(_i2cAddressHex);
    success &= _i2c->write(( uint8_t*)"O,S,1", 5);  // Enable salinity
    success &= !_i2c->endTransmission();
    success &= waitForProcessing();
    ...
    _i2c->beginTransmission(_i2cAddressHex);
    success &= _i2c->write(( uint8_t*)"O,SG,1",
